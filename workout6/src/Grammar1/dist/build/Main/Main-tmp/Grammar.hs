...
happyExpList = HappyA# "\x00\x00\x00\x00\x00\x00"#

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseTp","Tp","'('","')'","'->'","%eof"]
...
happyActOffsets = HappyA# "\x00\x00\x00\x00\xfd\xff\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x02\x00\x00\x00\x00\x00\x00\x00"#
...
happyCheck = HappyA# "\xff\xff\x04\x00\x00\x00\xff\xff\xff\xff\xff\xff\xff\xff"#

happyTable :: HappyAddr
happyTable = HappyA# "\x00\x00\xff\xff\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00"#
...
parseTp tks = happyRunIdentity happySomeParser where
